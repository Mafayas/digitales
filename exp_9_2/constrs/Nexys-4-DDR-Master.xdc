...
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { sniff_2 }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { sniff_3 }]; #IO_L21P_T3_DQS_15 Sch=ja[3]
...
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN }]; #IO_L17P_T2_35 Sch=jd[2]
